...
sys.stdout = open(dir_path + '/debug.txt', 'w')
...
class NoteFields:
    ...
    def buildMappings(self):
        ...
        print(pprint.pformat(self.modelFieldPos, indent=4))
        print(pprint.pformat(self.advBrowser.customTypes, indent=4))
        print(pprint.pformat(mw.col.models.models, indent=4))
